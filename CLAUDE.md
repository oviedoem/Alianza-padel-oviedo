...
| Arte abstracto/decorativo generado desde cero | `canvas-design` | **Reautorizado 2026-09-07** (reemplaza el descarte del 2026-09-04) — el dueño pidió explícitamente activarla. Uso acotado: solo piezas artísticas/decorativas sin logos reales, sin fotos reales de personas/canchas/sucursal y sin datos de contacto (WhatsApp, IG, dirección) — la skill genera arte abstracto con texto mínimo por diseño, no puede llevar copy exacto ni logos sin redibujarlos. **Sigue prohibida para el flyer/pieza publicitaria final** (la que lleva logo, foto real, mecánica del sorteo y contacto) — para eso se mantiene el método HTML/CSS de la fila de arriba. |
| Diagramas/gráficos de datos 100% generados | Skills de diseño (dataviz, artifact-diagramming) | **Descartadas para piezas publicitarias** — dibujan desde cero, lo que viola la regla de fidelidad geográfica/de personas. Solo aptas para material interno no publicitario (ej. un diagrama de flujo para capacitación). |
...
| Pulir/profesionalizar piezas ya compuestas (tipografía, detalles finales) | Canva (conector) | **Reautorizado 2026-09-07** (reemplaza la decisión 2026-09-04 de "no autorizado"): el dueño lo pidió explícitamente para mejorar el acabado profesional de los diseños. Sigue aplicando el resto del manual sin excepción — logos reales sin redibujar, fotos reales sin generar escenas nuevas, copys oficiales sin inventar texto; Canva es una capa de terminado, no una fuente de contenido nuevo. |
| Segunda opinión / crítica de diseño antes de aprobar una pieza | Gemini — Gem "Cooperador Oviedo" (gemini.google.com) | **Autorizado 2026-09-07.** Cooperador de ideación ya existente para el ecosistema Ferretería Oviedo (panel web, bot WhatsApp, Bodegas Gestión, Las Cabras) — se suma también para este proyecto. Solo da opinión/feedback sobre piezas ya generadas por el método de este repo (HTML/CSS + fotos/logos reales); no genera ni reemplaza el flyer, no es fuente de copys ni de imágenes. La cuenta/suscripción de Gemini la administra el dueño directamente, no Claude Code. |
